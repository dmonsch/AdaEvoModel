...
import adaevomodel.runtime.pipeline.pcm.repository.regression.ParametricLinearRegression;
import adaevomodel.runtime.pipeline.pcm.repository.tree.TreeNode;
import adaevomodel.runtime.pipeline.pcm.repository.usage.IUsageEstimation;
...
public class TimelineAnalyzer implements ITimelineAnalysis {
	...
	public RepositoryStoexChanges analyze(IResourceDemandTimeline timeline) {
		...
		LOG.info("Write adjusted Stoexs back to the model.");
		...
		LOG.info("Finished writing back of Stoexs.");
