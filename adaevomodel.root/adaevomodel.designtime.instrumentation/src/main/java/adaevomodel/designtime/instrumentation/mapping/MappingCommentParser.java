package adaevomodel.designtime.instrumentation.mapping;

import java.util.Optional;
import java.util.regex.Matcher;
import java.util.regex.Pattern;

import adaevomodel.designtime.instrumentation.mapping.comment.AbstractMappingComment;
import adaevomodel.designtime.instrumentation.mapping.comment.BranchMappingComment;
import adaevomodel.designtime.instrumentation.mapping.comment.ExternalCallMappingComment;
import adaevomodel.designtime.instrumentation.mapping.comment.InternalActionMappingComment;
import adaevomodel.designtime.instrumentation.mapping.comment.LoopMappingComment;
