...
class ReactionsExecutor extends AbstractReactionsExecutor {
  public ReactionsExecutor() {
    super(new adaevomodel.base.vsum.domains.RuntimeEnvironmentDomainProvider().getDomain(), 
    	new adaevomodel.base.vsum.domains.ExtendedPcmDomainProvider().getDomain());
  }
